...
/**
 * @generated
 * Generated Class: EPCXv2
 * @type-descriptor.aggregate-instance-td accessor="readWrite" contentSize="195" offset="0" size="195"
...
public class EPCXv2 implements javax.resource.cci.Record,
	...
	private static final long serialVersionUID = -1150258319290857172L;
	/**
	 * @generated
	 */
	...
	static {
		...
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__programInitialValue, initializedBuffer_, 156, "IBM-037",
				8, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		String epcx__applidInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__applidInitialValue, initializedBuffer_, 124, "IBM-037",
				8, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		String epcx__tranidInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__tranidInitialValue, initializedBuffer_, 132, "IBM-037",
				4, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		String epcx__useridInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__useridInitialValue, initializedBuffer_, 136, "IBM-037",
				8, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		...
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__netqualInitialValue, initializedBuffer_, 116, "IBM-037",
				8, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		String fill__0InitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				fill__0InitialValue, initializedBuffer_, 153, "IBM-037", 3,
		...
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				...
				8, MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		String epcx__event__typeInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__event__typeInitialValue, initializedBuffer_, 152,
				"IBM-037", 1, MarshallStringUtils.STRING_JUSTIFICATION_LEFT,
				" ");
		String epcx__uowidInitialValue = " ";
		MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
				epcx__uowidInitialValue, initializedBuffer_, 168, "IBM-037",
	 ...
	 * @generated
	 */
	public EPCXv2(java.util.HashMap valFieldNameMap) {
	 ...
	 * @type-descriptor.level88 name="epcx__current__version" value="2"
	 * @type-descriptor.level88 name="epcx__version__2" value="2"
	...
	public boolean isEpcx__current__version(int epcx__current__version) {
		return (epcx__current__version == 2);
	}

	/**
	 * @generated
	 */
	public int getEpcx__version__2() {
		return (2);
	}
	 ...
	 * @generated
	 */
	public boolean isEpcx__version__2(int epcx__version__2) {
		return (epcx__version__2 == 2);
	}
	 ...
	 * @type-descriptor.level88 name="epcx__current__schema__version" value="2"
	 * @type-descriptor.level88 name="epcx__schema__version__2" value="2"
	...
	public boolean isEpcx__current__schema__version(
		...
		return (epcx__current__schema__version == (short) 2);
	}

	/**
	 * @generated
	 */
	public short getEpcx__schema__version__2() {
		return ((short) 2);
	}
	 ...
	 * @generated
	 */
	public boolean isEpcx__schema__version__2(short epcx__schema__version__2) {
		return (epcx__schema__version__2 == (short) 2);
	}
	 ...
	 * @type-descriptor.restriction maxLength="8"
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="8" offset="116" size="8"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
			...
			if (epcx__netqual.length() > 8)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__netqual,
								"8", "epcx__netqual"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__netqual, buffer_, 116, "IBM-037", 8,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	 ...
	 * @type-descriptor.restriction maxLength="8"
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="8" offset="124" size="8"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
	public String getEpcx__applid() {
		String epcx__applid = null;
		epcx__applid = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 124, "IBM-037",
						8);
		return (epcx__applid);
	}
			...
			if (epcx__applid.length() > 8)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__applid,
								"8", "epcx__applid"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__applid, buffer_, 124, "IBM-037", 8,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	...
	public String getEpcx__tranid() {
		...
		epcx__tranid = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 132, "IBM-037",
						4);
		return (epcx__tranid);
	}
			...
			if (epcx__tranid.length() > 4)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__tranid,
								"4", "epcx__tranid"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__tranid, buffer_, 132, "IBM-037", 4,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	...
	public String getEpcx__userid() {
		...
		epcx__userid = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 136, "IBM-037",
						8);
		return (epcx__userid);
	}
			...
			if (epcx__userid.length() > 8)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__userid,
								"8", "epcx__userid"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__userid, buffer_, 136, "IBM-037", 8,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	...
	public void setEpcx__abstime(long epcx__abstime) {
		...
		MarshallPackedDecimalUtils.marshallPackedDecimalIntoBuffer(
				epcx__abstime, buffer_, 144, 8, true);
	}
	 ...
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.level88 name="epcx__system" value="S"
	 * @type-descriptor.level88 name="epcx__application" value="A"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="1" offset="152" size="1"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
	public String getEpcx__event__type() {
		String epcx__event__type = null;
		epcx__event__type = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 152, "IBM-037",
						1);
		return (epcx__event__type);
	}

	/**
	 * @generated
	 */
	public void setEpcx__event__type(String epcx__event__type) {
		if (epcx__event__type != null) {
			if (epcx__event__type.length() > 1)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E,
								epcx__event__type, "1", "epcx__event__type"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__event__type, buffer_, 152, "IBM-037", 1,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	 ...
	 * @generated
	 */
	public boolean isEpcx__system(String epcx__system) {
		return ("S".equals(epcx__system));
	}

	/**
	 * @generated
	 */
	public String getEpcx__application() {
		return ("A");
	}
	 ...
	 * @generated
	 */
	public boolean isEpcx__application(String epcx__application) {
		return ("A".equals(epcx__application));
	}
	 ...
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="3" offset="153" size="3"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
	public String getFill__0() {
		String fill__0 = null;
		fill__0 = MarshallStringUtils.unmarshallFixedLengthStringFromBuffer(
				buffer_, 153, "IBM-037", 3);
		return (fill__0);
	}
	...
	public String getEpcx__program() {
		...
		epcx__program = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 156, "IBM-037",
						8);
			...
			if (epcx__program.length() > 8)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__program,
								"8", "epcx__program"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__program, buffer_, 156, "IBM-037", 8,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
	 ...
	 * @type-descriptor.initial-value kind="SPACE"
	 * @type-descriptor.simple-instance-td accessor="readWrite" contentSize="27" offset="168" size="27"
	 * @type-descriptor.string-td characterSize="1" lengthEncoding="fixedLength" paddingCharacter=" " prefixLength="0"
	 */
	public String getEpcx__uowid() {
		String epcx__uowid = null;
		epcx__uowid = MarshallStringUtils
				.unmarshallFixedLengthStringFromBuffer(buffer_, 168, "IBM-037",
						27);
		return (epcx__uowid);
	}
			...
			if (epcx__uowid.length() > 27)
				throw new IllegalArgumentException(MarshallResource.instance()
						.getString(MarshallResource.IWAA0124E, epcx__uowid,
								"27", "epcx__uowid"));
			MarshallStringUtils.marshallFixedLengthStringIntoBuffer(
					epcx__uowid, buffer_, 168, "IBM-037", 27,
					MarshallStringUtils.STRING_JUSTIFICATION_LEFT, " ");
		}
	}
